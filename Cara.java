...
public class Cara extends JPanel implements ActionListener {
    ...
    public void regenerate() {
        ...
        int amntshapes =  random.nextInt(20)+10;
        RandomShape shape;
        for (int i = 0; i <= amntshapes ;i ++){
            int shapechooser = random.nextInt(4);
            switch (shapechooser){
                case 0: shape = new RandomSpiral(FrameWidth,FrameHeight);
                break;
                case 1: shape = new RandomCircle(FrameWidth,FrameHeight);
                break;
                case 2: shape = new RandomGlobe(FrameWidth,FrameHeight);
                break;
                case 3: shape = new RandomStar(FrameWidth,FrameHeight);
                break;
